...
public class CryptLib {
    ...
    public String generateRandomIV16() {
        ...
        if (16 > new String(result).length()) {
            return new String(result);
        } else {
            return new String(result).substring(0, 16);
        }
    }
    ...
    public String password() {        
        ...
        char passwordArray[] = console.readPassword("Enter your secret key: ");
    ...
    public static void main(String [] args) throws NoSuchAlgorithmException, NoSuchPaddingException, Exception {
    	...
    	if (args[0].equals("-e")) {
    		System.out.println(new CryptLib().encryptPlainTextWithRandomIV(args[1],new CryptLib().password()));
    	} else if (args[0].equals("-d")) {
    		System.out.println(new CryptLib().decryptCipherTextWithRandomIV(args[1],new CryptLib().password()));
    	}else {
			System.out.println("usage: java -jar encr.jar -e text pass");
		}
